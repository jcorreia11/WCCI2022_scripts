...
def baseline_dnn_model(n_hidden_layers = 6,
                       units_hidden_layers = 256,
                       dropout_1 = 0.2,
                       dropout_hidden_layers = 0,
                       l1 = 0,
                       l2 = 0):
    # create model
    model = Sequential()
...
def train_morgan_dnn_regression(output_path = 'outputs/regression_dnn_morgan_metainter_retrorules/',
                                    reduce_lr_args=None,
    ...
    estimator.model.save(folder + '/trained_model_dnn_morgan_regr.h5')

    estimator.model.save_weights(folder + '/trained_model_dnn_morgan_weights_regr.h5')
