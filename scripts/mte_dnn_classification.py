...
def baseline_dnn_model(n_hidden_layers = 2,
                       units_hidden_layers = 1024,
                       dropout_1 = 0,
                       dropout_hidden_layers = 0.4,
                       l1 = 0,
                       l2 = 0.01):
    # create model
    model = Sequential()
...
def train_mte_dnn_classification(output_path = 'outputs/multiclass_dnn_mte_metainter_retrorules/',
                                    reduce_lr_args=None,
    ...
    estimator.model.save(folder + '/trained_model_dnn_mte_class.h5')

    estimator.model.save_weights(folder + '/trained_model_dnn_mte_weights_class.h5')
    ...
    plt.savefig(folder + '/accuracy_history_dnn_mte_class.png')
    plt.close()
    ...
    plt.legend(['train', 'val'], loc='upper left')
    plt.show()
    plt.savefig(folder + '/loss_history_dnn_mte_class.png')
    plt.close()



if __name__ == '__main__':
    train_mte_dnn_classification()