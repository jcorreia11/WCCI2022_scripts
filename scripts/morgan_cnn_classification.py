...
def train_morgan_cnn_classification(output_path = 'outputs/multiclass_cnn_morgan_metainter_retrorules/',
                                    reduce_lr_args=None,
    ...
    plt.savefig(folder + '/accuracy_history_cnn_morgan.png')
    plt.close()
    ...
    plt.legend(['train', 'val'], loc='upper left')
    plt.show()
    plt.savefig(folder + '/loss_history_cnn_morgan.png')
    plt.close()



if __name__ == '__main__':
    train_morgan_cnn_classification()